...
const benefits = [
  ...
  "Dansk IT-support inkluderet",
  "Hurtig hjælp via fjernsupport",
    ...
    <section className="bg-white py-20 md:py-24">
      <div className="mx-auto max-w-6xl px-4 lg:px-6">
        <SectionHeader
          ...
          description="Du køber ikke kun hardware — du får en komplet løsning med opsætning, support og tryghed."
        />
